...
public class BulletScript : MonoBehaviour
{
	...
	private void Start()
	{
		...
		else if (this.bulletTrace != null)
		{
			...
			if (this.bulletTrace.transform.parent != base.transform)
			{
				gameObject2 = (CachedObject.Instantiate(this.bulletTrace, base.transform.position, base.transform.rotation) as GameObject);
			}
			else
			{
				gameObject2 = this.bulletTrace;
			}
