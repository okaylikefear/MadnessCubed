...
public class SFE_shieldedController : MonoBehaviour
{
	...
	public virtual void Start()
	{
		...
		this.shieldObject.GetComponent<Renderer>().material.SetFloat("_AllPower", this.normalShieldGfxPower);
	}
	...
	public virtual void Update()
	{
		...
		{
			this.shieldObject.GetComponent<Renderer>().material.SetFloat("_AllPower", this.power);
