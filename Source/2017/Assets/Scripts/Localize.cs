...
public class Localize
{
	...
	public static string T(string key, string def = null)
	{
		...
		if (num != -1)
		{
			int num2 = DataUtils.IntParseFast(key.Substring(num));
			key = key.Substring(0, num);
			num = num2;
		}
		FieldInfo field = Localize._tt.GetField(key);
		if (field == null)
		{
		...
		{
			Localize._hash[key] = ((string[])field.GetValue(null))[num];
		}
		else
		{
			Localize._hash[key] = (string)field.GetValue(null);
		}
		return Localize._hash[key];
	}
	...
	public static string weaponchangeafterrespawn = "Оружие поменяется после смерти или респауна";

	public static string[] TaskType;

	public static string[] DailyTask = new string[]
	{
		"Убить",
		"Убить из {0}",
		"Убить в голову",
	...
	public static string[] task_name = new string[]
	{
		string.Empty,
		string.Empty,
		string.Empty,
	...
	public static string ui_daily3_done;

	public static string task_story;
	...
	public static string ps_tap_for_respawn = "Tap screen to respawn";
