	...
	private void Update()
	{
		if (Kube.OH != null)
		{
			if (Kube.OH.smoothMove)
			{
				...
				base.transform.position = Vector3.Lerp(base.transform.position, base.transform.parent.TransformDirection(this.initPosition) + base.transform.parent.position, Time.deltaTime * this.posKoeff);
				base.transform.rotation = Quaternion.Lerp(base.transform.rotation, base.transform.parent.rotation, Time.deltaTime * this.rotationKoeff);
			}
