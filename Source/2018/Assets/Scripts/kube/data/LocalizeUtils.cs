...
namespace kube.data
{
	public class LocalizeUtils
	{
		...
		public static void load(byte[] csv, bool clear = true)
		{
			...
			foreach (string text2 in dictionary.Keys)
			{
				...
				if (field2 != null)
				{
					string[] array3 = (string[])field2.GetValue(null);
					List<string> list2 = dictionary[text2];
					if (array3 != null)
					{
						int num4 = Math.Min(array3.Length, list2.Count);
