...
public class PlatformFB : PlatformBase
{
	...
	public PlatformFB(SocialNet owner, GameObject go, string func) : base(owner)
	{
		Kube.GPS.SetLocale("en_US");
	}
	...
	public override void OnUserInfo(JsonData data)
	{
		...
		this._owner.moneyName = this.currency;
		this._owner.hasMoneyIcon = false;
		this._owner.moneyValue = this.usd_exchange_inverse;
