...
public class MaptopMyTab : MonoBehaviour
{
	...
	public void LoadAndShow()
	{
		...
		Kube.SS.Request(800, null, new ServerScript.ServerCallback(this.onLoaded));
	}
	...
	private void Invalidate()
	{
		...
		this.addslot.GetComponentInChildren<UILabel>().text = string.Format(" Добавить за " + this._addprice, new object[0]);
	...
	public void onResetSlot(MyMaptopItem mapItem)
	{
		...
		Kube.SS.Request(803, dictionary, new ServerScript.ServerCallback(this.onReset));
	}
