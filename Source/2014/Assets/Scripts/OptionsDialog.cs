...
public class OptionsDialog : MonoBehaviour
{
	...
	public void onMusicChange()
	{
		...
		component.audio.volume = this.music.value;
	}
	...
	private void OnShow()
	{
		...
		float float3 = PlayerPrefs.GetFloat("musicVol", component.audio.volume);
	...
	public void OnApply()
	{
		...
		PlayerPrefs.SetFloat("mouseSens", this.mouse.value * 15f + 1f);
