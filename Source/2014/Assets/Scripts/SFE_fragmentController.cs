...
public class SFE_fragmentController : MonoBehaviour
{
	...
	public virtual void Start()
	{
		...
		this.rigidbody.AddTorque(this.transform.up * this.rnd, ForceMode.Impulse);
		this.rnd = UnityEngine.Random.Range(-this.impulseRot, this.impulseRot);
		this.rigidbody.AddTorque(this.transform.right * this.rnd, ForceMode.Impulse);
		this.rnd = UnityEngine.Random.Range(-this.impulseRot, this.impulseRot);
		this.rigidbody.AddTorque(this.transform.forward * this.rnd, ForceMode.Impulse);
		this.rigidbody.AddRelativeForce(new Vector3(UnityEngine.Random.Range(-this.impulseForce, this.impulseForce), UnityEngine.Random.Range(-this.impulseForce, this.impulseForce), UnityEngine.Random.Range(-this.impulseForce, this.impulseForce)), ForceMode.Impulse);
	}
