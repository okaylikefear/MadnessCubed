...
public class CharMenu : MonoBehaviour
{
	...
	private void Invalidate()
	{
		...
		if (Kube.ASS2 != null)
		{
			list.Add(Kube.ASS2.inventarClothesHeadTex);
			list.Add(Kube.ASS2.inventarClothesTorsoTex);
			list.Add(Kube.ASS2.inventarClothesSpineTex);
			list.Add(Kube.ASS2.inventarClothesHandTex);
			list.Add(Kube.ASS2.inventarClothesLegTex);
			list.Add(Kube.ASS2.inventarClothesClavTex);
		}
		...
		{
			GameObject gameObject2 = NGUITools.AddChild(this.container.gameObject, this.itemPrefab);
			...
			if (this.clothesTypeNum == 0)
			{
				...
				if (Kube.ASS2 != null)
				{
					component2.GetComponentInChildren<UITexture>().mainTexture = Kube.ASS2.inventarSkinsTex[num];
				}
			...
			else
			{
				...
				if (Kube.ASS2 != null)
				{
					component2.GetComponentInChildren<UITexture>().mainTexture = list[this.clothesTypeNum - 1][j];
				}
