...
public class UIInput : MonoBehaviour
{
	...
	protected virtual bool ProcessEvent(Event ev)
	{
		...
		bool flag = platform == RuntimePlatform.OSXEditor || platform == RuntimePlatform.OSXPlayer || platform == RuntimePlatform.WebGLPlayer;
		bool flag2 = (!flag) ? ((ev.modifiers & EventModifiers.Control) != (EventModifiers)0) : ((ev.modifiers & EventModifiers.Command) != (EventModifiers)0);
		bool flag3 = (ev.modifiers & EventModifiers.Shift) != (EventModifiers)0;
