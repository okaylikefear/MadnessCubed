	...
	private void Start()
	{
		if (PhotonNetwork.isMasterClient)
		{
			...
			for (int i = 0; i < 100; i++)
			{
				...
				if (Kube.WHS.IsInWorld((int)pos.x, (int)pos.y, (int)pos.z) && !Kube.WHS.isOccupied[(int)pos.x, (int)pos.y, (int)pos.z] && !Kube.WHS.isOccupied[(int)pos.x, (int)pos.y + 1, (int)pos.z] && Kube.WHS.cubes[(int)pos.x, (int)pos.y, (int)pos.z].type == 0 && Kube.WHS.cubes[(int)pos.x, (int)pos.y + 1, (int)pos.z].type == 0)
				{
