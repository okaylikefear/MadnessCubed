...
namespace CodeStage.AntiCheat.ObscuredTypes
{
	...
	public struct ObscuredVector3
	{
		...
		private Vector3 InternalDecrypt()
		{
			...
			Vector3 vector;
			vector.x = ObscuredFloat.Decrypt(this.hiddenValue.x, key);
			vector.y = ObscuredFloat.Decrypt(this.hiddenValue.y, key);
			vector.z = ObscuredFloat.Decrypt(this.hiddenValue.z, key);
