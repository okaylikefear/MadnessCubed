...
public class PlatformVK : PlatformBase
{
	...
	private void InitVK()
	{
		if (Application.isEditor)
		{
			...
			{
				"api_url=http://api.vk.com/api.php&api_id=2854688&api_settings=9222&viewer_id=",
				this._owner.debugID,
				"&viewer_type=2&sid=4cd603579cc7884bf5818775f52fd6164900e20b4c79affbd5aea9dd1b6636c61a9bf12e3fb870e82dd81&secret=84a755c9f8&access_token=",
				this.access_token,
				"&user_id=1185293&group_id=0&is_app_user=1&auth_key=",
				this._owner.secret,
				"&language=0&parent_language=0&ad_info=ElsdCQBdSVBmDAdNRARQBHRyFAsmMQxVUUZGNgBQbwYfQyQrWQA=&is_secure=0&referrer=user_apps&lc_name=cdc3cbc4&hash="
			}));
		}
	}
