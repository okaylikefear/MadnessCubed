...
public class DominatingPointScript : MonoBehaviour
{
	...
	public void ChangeTeam(int newTeam)
	{
		...
		if (newTeam == -1)
		{
			this.dominatingPointRenderer.renderer.material.color = Color.white;
		}
		else
		{
			this.dominatingPointRenderer.renderer.material.color = Kube.OH.teamColor[newTeam];
		}
		this.light.color = this.dominatingPointRenderer.renderer.material.color;
		this.light2.color = this.dominatingPointRenderer.renderer.material.color;
