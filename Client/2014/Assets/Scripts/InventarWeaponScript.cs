...
public class InventarWeaponScript : MonoBehaviour
{
	...
	private void SetNewWeapon(int numWeapon)
	{
		...
		if (numWeapon < 0 || numWeapon >= Kube.ASS6.charWeaponsGO.Length)
		{
			return;
		}
		this.weapon = (UnityEngine.Object.Instantiate(Kube.ASS6.charWeaponsGO[numWeapon], base.transform.position, base.transform.rotation) as GameObject);
