...
public class TriggerScript : GameMapItem
{
	...
	public void SaveTrigger()
	{
		...
		if (this.id == -1)
		{
			...
			MonoBehaviour.print("New trigger id: " + this.id);
		}
		this.condActivate = 0;
	...
	private void setupGUI()
	{
		...
		{
			GUI.Label(new Rect(num3 + 300f, num4 + 5f, 250f, 30f), "Номер события: " + this.delayTime);
	...
	{
		if (other.transform.root.gameObject == Kube.IS.ps.gameObject && this.cond1_near && Kube.IS.ps.HaveKeys(this.cond2_red, this.cond2_green, this.cond2_blue, this.cond2_gold))
		{
	...
	{
		if (this.cond1_press && Kube.IS.ps.HaveKeys(this.cond2_red, this.cond2_green, this.cond2_blue, this.cond2_gold))
		{
			this.lastGOInTrigger = Kube.IS.ps.gameObject;
