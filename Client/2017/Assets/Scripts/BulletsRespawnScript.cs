...
public class BulletsRespawnScript : MonoBehaviour
{
	private void Start()
	{
		this.Init();
	...
	private void Init()
	{
		...
		this.IPS = base.GetComponentInParent<ItemPropsScript>();
		if (this.NO == null)
		{
			this.NO = Kube.BCS.NO;
		}
	...
	private void OnTriggerEnter(Collider other)
	{
		if (this.IPS.state != 0 && other.gameObject.transform.root.gameObject.layer == 9)
		{
			...
			component.GetNewBullets(this.respawnNumBullets[this.numRespawn], this.respawnAmountOfBullets[this.numRespawn]);
