...
public class MainMenu : Cub2Menu
{
	...
	{
		MonoBehaviour monoBehaviour = Cub2Menu.Find<MonoBehaviour>("Bank_menu");
		ModalChild[] componentsInChildren = Cub2UI.instance.GetComponentsInChildren<ModalChild>(true);
	...
	public void Start()
	{
		...
		if (string.IsNullOrEmpty(Kube.GPS.playerName))
		{
			Cub2UI.FindAndOpenDialog("dialog_name");
		}
