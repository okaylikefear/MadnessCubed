...
public class MonsterRespawnScript : GameMapItem
{
	...
	private void setupGUI()
	{
		...
		else
		{
			...
			GUI.Label(new Rect(num3 + 10f, num4 + 110f, 300f, 30f), Localize.monster_health_mult + ": " + Localize.need_vip);
			this.healthMultiplier = 0;
			GUI.Label(new Rect(num3 + 10f, num4 + 140f, 300f, 30f), Localize.monster_damage_mult + ": " + Localize.need_vip);
